      ...
      <section className="w-full ml-0 m-0 h-fit px-5 pt-20 lg:pl-[320px] gap-7 flex flex-col min-h-screen py-4 justify-center">
        <div>
          ...
          <p className="text-xl text-stone-600 text-justify mt-5">
            Welcome to GrabIt, the ultimate destination for online auctions and
            bidding excitement. Established in 2024, we aim to redefine the
        ...
        <div>
          ...
          <p className="text-xl text-stone-600 text-justify">
            At GrabIt, our mission is to revolutionize how people buy and sell
        ...
        <div>
          ...
          <p className="text-xl text-stone-600 text-justify">
            Founded by Samarjit, GrabIt was created from a deep-seated passion
            ...
            GrabIt stands as a testament to our dedication to excellence,
        ...
        <div>
          ...
          <p className="text-xl text-stone-600 text-justify">
            ...
            reach, or simply explore a world of possibilities, GrabIt welcomes
        ...
        <div>
          <p className="text-[#4749e9] text-xl font-bold mb-3">
            Thank you for choosing GrabIt. We are honored to have you with us
